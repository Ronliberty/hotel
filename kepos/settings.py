"""
Django settings for kepos project.
...
SECRET_KEY = 'django-insecure-q(lyh-dabyc2i66ojj=ak_c^z%x=y+=$na^k7e0l#qi%qd4-3e'
...
WSGI_APPLICATION = 'kepos.wsgi.application'
